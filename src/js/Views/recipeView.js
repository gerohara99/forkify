import icons from 'url:../../img/icons.svg'; // 'url' notation needed for Parcel 2
...
class RecipeView extends View {
  ...
  addHandleRender(handler) {
    // If Url or Hash on url changes then call controlRecipes
    ...
    <li class="recipe__ingredient">
      <svg class="recipe__icon">
       ...
       <div class="recipe__quantity">${
         fracty(ing.quantity) ? fracty(ing.quantity) : ''
       }</div>
